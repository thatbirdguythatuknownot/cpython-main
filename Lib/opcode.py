...
def_op('LOAD_FAST', 123)        # Local variable number
haslocal.append(123)
def_op('STORE_FAST', 124)       # Local variable number
haslocal.append(124)
def_op('DELETE_FAST', 125)      # Local variable number
haslocal.append(125)

def_op('INCREMENT', 126)
def_op('DECREMENT', 127)
