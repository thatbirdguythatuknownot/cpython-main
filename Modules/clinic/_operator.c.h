...
PyDoc_STRVAR(_operator_inc__doc__,
"inc($module, a, /)\n"
"--\n"
"\n"
"Same as ++a.");

#define _OPERATOR_INC_METHODDEF    \
    {"inc", (PyCFunction)_operator_inc, METH_O, _operator_inc__doc__},

PyDoc_STRVAR(_operator_dec__doc__,
"dec($module, a, /)\n"
"--\n"
"\n"
"Same as --a.");

#define _OPERATOR_DEC_METHODDEF    \
    {"dec", (PyCFunction)_operator_dec, METH_O, _operator_dec__doc__},
...
/*[clinic end generated code: output=f35072adf19201df input=a9049054013a1b77]*/
